...
import 'package:todo_app/src/shared/logger.dart';
          ...
          children: [
            const DrawerHeader(
              child: Column(
                ...
                children: [
                  CircleAvatar(
                    backgroundColor: Color(0xFFFFEBEE), // Colors.red[50]
                    radius: 40,
                    child: Text(
                      'JA',
                      style: TextStyle(
            ...
            const ListTile(
                leading: Icon(Icons.warning), title: Text('Críticas')),
            ListTile(
        ...
        itemBuilder: (BuildContext context, int index) {
          return Dismissible(
            confirmDismiss: (direction) async {
              ...
              //? Para eliminar
              final confirmed = await Utils.showConfirm(
                context: context,
            ...
            onDismissed: (direction) {
              Logger.debug('Item dismissed with direction: $direction');
              Utils.showSnackBar(
                context: context,
